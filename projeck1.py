# hal pertama adalah membuat user id
user_id = 0
loop = "n" # menggunakan looping untuk mengembalikan program kesemula
user =  [
            {   
                "id":"1234",
...
#membuat variabel dengan velue false
status_login = False
pakai_atm = "y"
# deff itu tujuan nya adalah untuk mendefinisikan fungsi dan memberikan kode yang akan dijalankan ketika fungsi tersebut dipanggil
def cek_login(p):
    for us in user:
        if us['pin'] == p:
            return us
...
while pakai_atm == "y":
    while status_login == False:
        print("SELAMAT DATANG DI ATM BANK BANK TOOT")
